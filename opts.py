...
def parse_opts():
    ...
    parser.add_argument('--root_path',
                        default="/home/zouyiping/ucf_frames",
                        type=str,
                        help='Root directory path')
    parser.add_argument('--split_path',
                        default="/home/zouyiping/C3D_ELM/split",
                        type=str,
                        help='Directory path of splitfiles')
    parser.add_argument('--split_name',
                        default="trainlist01",
                        type=str,
                        help='name of splitfile')
    parser.add_argument('--result_path',
                        default="/home/zouyiping/C3D_ELM/log",
                        type=str,
                        help='Result directory path')
    parser.add_argument('--no_logger',
                        action='store_true',
                        help='If true, settings are not recorded.')
    parser.add_argument(
        '--dataset',
        default='ucf101',
        type=str,
